...
- Nemotron 3 Super and Nemotron 3.5 Lightning serving notes (sizing, launch
  profiles, KV dtype, the 1M single-session profile): see [`docs/nemotron.md`](nemotron.md).
