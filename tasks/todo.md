...
- [x] (f) Prefix auto-pin after second match (c819a81..88f6c6f, live 22:50) + /v1/stats scheduler.prefix.{hits,hit_tokens,miss_tokens,pinned_tokens}
...
- [x] (g) pooled requests take prefix hits (hybrid radix): all-layer fp32 sums ride on snapshot
